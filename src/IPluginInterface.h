...
{
public:
	virtual void OnAttach(RE::TESObjectREFR * refr, RE::TESObjectARMO * armor, RE::TESObjectARMA * addon, NiAVObject * object, bool isFirstPerson, NiNode * skeleton, NiNode * root) = 0;
};
...
public:
	...
	virtual void ApplyVertexDiff(RE::TESObjectREFR * refr, NiAVObject * rootNode, bool erase = false) = 0;
...
public:
	...
	virtual bool GetOverrideNodeTransform(RE::TESObjectREFR* refr, bool firstPerson, bool isFemale, const char* node, const char* name, skee_u16 key, NiTransform* result) = 0;
...
{
public:
	virtual bool AttachMesh(RE::TESObjectREFR* ref, const char* nifPath, const char* name, bool firstPerson, bool replace, const char** filter, skee_u32 filterSize, NiAVObject*& out, char* err, skee_u64 errBufLen) = 0;
...
public:
	...
	using OverlayInstallCallback = void (*)(RE::TESObjectREFR* ref, NiAVObject* node);
...
public:
	...
	virtual void ApplyArmorOverrides(RE::TESObjectREFR* refr, RE::TESObjectARMO* armor, RE::TESObjectARMA* addon, NiAVObject* object, bool immediate) = 0;
	...
	virtual void ApplyNodeOverrides(RE::TESObjectREFR* refr, NiAVObject* object, bool immediate) = 0;
	...
	virtual void ApplySkinOverrides(RE::TESObjectREFR* refr, bool firstPerson, RE::TESObjectARMO* armor, RE::TESObjectARMA* addon, skee_u32 slotMask, NiAVObject* object, bool immediate) = 0;
